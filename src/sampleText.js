export const sampleText = `One thing was certain, that the white kitten had had nothing to do with
...
dinner: then, when the miserable day came, I should have to go
without fifty dinners at once! Well, I shouldn't mind that much! I'd
...
it was a nice check, Kitty, and really I might have won, if it hadn't
...
the things Alice used to say, beginning with her favourite phrase
...
had argued that they couldn't, because there were only two of them,
and Alice had been reduced at last to say, "Well, you can be one of
them then, and I'll be all the rest." And once she had really
frightened her old nurse by shouting suddenly in her ear, "Nurse! Do
...
there's a dear!" And Alice got the Red Queen off the table, and set
it up before the kitten as a model for it to imitate: however, the
thing didn't succeed, principally, Alice said, because the kitten
wouldn't fold its arms properly. So, to punish it, she held it up to
the Looking-glass, that it might see how sulky it was--'and if you're
...
I know that, because I've held up one of our books to the glass, and
...
good to drink--But oh, Kitty! now we come to the passage. You can just
see a little peep of the passage in Looking-glass House, if you leave
the door of our drawing-room wide open: and it's very like our
...
beautiful things in it! Let's pretend there's a way of getting
through into it, somehow, Kitty. Let's pretend the glass has got all
soft like gauze, so that we can get through. Why, it's turning into a
sort of mist now, I declare! It'll be easy enough to get through--"
